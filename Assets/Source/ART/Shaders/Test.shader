...
Shader "Toony Colors Pro 2/User/Test"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma instancing_options assumeuniformscaling nolodfade nolightprobe
...
/* TCP_DATA u config(unity:"2021.3.3f1";ver:"2.8.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","SHADOW_COLOR_MAIN_DIR","SPEC_LEGACY","SPECULAR","SPECULAR_TOON_BAND","SPECULAR_SHADER_FEATURE","RIM","RIM_SHADER_FEATURE","FOG","DISABLE_ADDITIONAL_LIGHTS","TEMPLATE_LWRP","CULLING"];flags:list[];flags_extra:dict[pragma_gpu_instancing=list["assumeuniformscaling","nolodfade","nolightprobe"]];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="2.5",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,sp(name:"Face Culling";imps:list[imp_enum(value_type:1;value:0;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"11bb30c0-66a3-4120-8f0b-c96e9d3a0325";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH e1b9918d2e72f561d406cfc14bf068a1 */
